...
try:
    test=rbps(np.zeros(44100),0,44100)
except:
    print('Rubberband may not be installed on this computer.\nPitch shifting will fall back on the librosa method, which may cause some unwanted artifacts.')